...
//	WebDriver driver;
	...
	public void testSetup(){
		...
		// инициализация объекта html-моделью с выполнением в памяти (без запуска браузера)
...
//		YandexInitPage yandexInitPage = new YandexInitPage(driver);
		...
		// находим ссылку на Яндекс.Погоду и переходим по ней
		YandexWeatherPage yandexWeatherPage = yandexInitPage.clickOnWeather();
		
		// получаем урл, парсим и сравниваем результат
